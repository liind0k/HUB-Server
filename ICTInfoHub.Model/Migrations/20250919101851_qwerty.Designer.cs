...
namespace ICTInfoHub.Model.Migrations
{
    ...
    [Migration("20250919101851_qwerty")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ICTInfoHub.Model.Model.CampusDepartment", b =>
                {
                    b.Property<int>("CampusDepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CampusDepartmentId"));
                    ...
                    b.HasKey("CampusDepartmentId");

                    b.HasIndex("CampusId");

                    b.HasIndex("DepartmentId");

                    b.ToTable("CampusDepartment");
                });
            ...
            modelBuilder.Entity("ICTInfoHub.Model.Model.Contact", b =>
                {
            ...
            modelBuilder.Entity("ICTInfoHub.Model.Model.Module", b =>
                {
                    b.Property<int>("ModuleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ModuleContact", b =>
                {
                    ...
                    b.HasKey("ModuleCode", "ContactId");

                    b.HasIndex("ContactId");

                    b.ToTable("ModuleContact", (string)null);
                });
            ...
            modelBuilder.Entity("CourseModule", b =>
                {
                    b.HasOne("ICTInfoHub.Model.Model.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ICTInfoHub.Model.Model.Module", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ModuleContact", b =>
                {
                    b.HasOne("ICTInfoHub.Model.Model.Contact", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ICTInfoHub.Model.Model.Campus", b =>
                {
                    b.Navigation("CampusDepartments");
